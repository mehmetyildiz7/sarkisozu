...
namespace MyEvernote.WebApp.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public ActionResult ByCategory(int? id)
        {
            ...
            List<Album> notes = noteManager.ListQueryable().Where(
        ...
        {
            BusinessLayerResult<User> res = evernoteUserManager.GetUserById(CurrentSession.User.Id);
        ...
        public ActionResult EditProfile(User model, HttpPostedFileBase ProfileImage)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                BusinessLayerResult<User> res = evernoteUserManager.UpdateProfile(model);
        ...
        public ActionResult Login(LoginViewModel model)
        {
            if (ModelState.IsValid)
            {
                BusinessLayerResult<User> res = evernoteUserManager.LoginUser(model);
        ...
        public ActionResult Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                BusinessLayerResult<User> res = evernoteUserManager.RegisterUser(model);
        ...
        {
            BusinessLayerResult<User> res = evernoteUserManager.ActivateUser(id);
